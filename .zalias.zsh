...
alias ompu='sudo wget https://github.com/JanDeDobbeleer/oh-my-posh/releases/latest/download/posh-linux-amd64 -O /data/data/com.termux/files/usr/bin/oh-my-posh && sudo chmod +x /data/data/com.termux/files//usr/bin/oh-my-posh'
